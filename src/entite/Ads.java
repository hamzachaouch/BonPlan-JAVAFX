...
public class Ads {
    ...
    public String toString() {
        return "Ads{" + "id=" + id + ", dateBegin=" + dateBegin + ", dateEnd=" + dateEnd + ", status=" + status + ", views=" + views + ", publicitePayee=" + publicitePayee + ", titre=" + titre + ", imgUrl=" + imgUrl + ", description=" + description + ", ville=" + ville + '}';
    }    
}